...
public interface IStatus {
	 ...
	 * @return an array of status objects * @see #isMultiStatus() */
	 ...
	 * <code>INFO</code>, <code>WARNING</code>,  or <code>CANCEL</code> * @see #matches(int) */
	 ...
	 *    <code>false</code> otherwise * @see #getChildren() */
	 ...
	 *    <code>false</code> if there are no matches * @see #getSeverity() * @see #CANCEL * @see #ERROR * @see #WARNING * @see #INFO */
