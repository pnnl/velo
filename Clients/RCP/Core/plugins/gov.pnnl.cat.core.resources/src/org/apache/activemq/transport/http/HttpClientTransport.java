...
public class HttpClientTransport extends HttpTransportSupport {
    ...
    protected HttpClient createHttpClient() {
        ...
        // Velo Change:  get proxy settings from our ProxyConfig object that can auto-detect
        // and support NTLM proxy authentication
        ...
        if (proxyConfig.getHost() != null) {
            ...
            if(proxyConfig.getProxyUsername() != null && proxyConfig.getProxyPassword() != null) {
              // basic scheme
