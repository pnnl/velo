 ...
 * than {@link org.apache.commons.httpclient.old.URI}.
 *
...
public class URIUtil {
     ...
     * 
     * @throws Exception if the default protocol charset is not supported
     *
     * @see URI#getDefaultProtocolCharset
     * @see #encode
     */
    public static String encodeAll(String unescaped) throws Exception {
     ...
     * @return the escaped string
     * 
     * @throws Exception if the charset is not supported
     * 
     * @see #encode
     */
     ...
     * @see #encode
     */
    public static String encodePathQuery(String unescaped) throws Exception {
     ...
     * @see #encode
     */
    public static String encodePath(String unescaped) throws Exception {
     ...
     * @see #encode
     */
    public static String encodeQuery(String unescaped) throws Exception {
     ...
     * 
     * @throws Exception if the string cannot be decoded (invalid)
     * 
     * @see URI#getDefaultProtocolCharset
     */
    public static String decode(String escaped) throws Exception {
        try {
