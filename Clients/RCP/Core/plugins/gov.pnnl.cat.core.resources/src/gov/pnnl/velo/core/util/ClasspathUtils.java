...
public class ClasspathUtils {
  private static Logger logger = CatLogger.getLogger(ClasspathUtils.class);
  ...
  public static File getFileFromClassFolder(Class clazz, String path) {
    ...
    try {
      if(url != null) {
    	...
    	ToolErrorHandler.handleError("",e, true);
      e.printStackTrace();
    }
    ...
    try {
      ...
      if(classLoader instanceof URLClassLoader) {
        ...
        getBundleClasspathFiles(toolsClassLoader, files);
          ...
          System.err.println("cannot find org.akuna.ui.tools.AkunaToolsPlugin");
        }
      }
    } catch (Throwable e) {
  ...
  /**
   * Method getBundleClasspathFiles.
