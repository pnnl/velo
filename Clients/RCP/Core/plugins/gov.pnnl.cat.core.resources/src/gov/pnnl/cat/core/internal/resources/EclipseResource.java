...
/**
 */
public abstract class EclipseResource extends EclipseResourceImpl implements IResource, IAdaptable {

  /**
   * Constructor for EclipseResource.
   * @param path CmsPath
   * @param type QualifiedName
   * @param mgr IResourceManager
   */
  public EclipseResource(CmsPath path, String type, IResourceManager mgr) {
    super(path, type, mgr);
  }
