...
/**
 */
public class TeamProfile extends Profile{
  ...
  public String getEmail() {
    return (String)properties.get(VeloConstants.PROP_TEAM_EMAIL);
  }
  ...
  public void setEmail(String email) {
    properties.put(VeloConstants.PROP_TEAM_EMAIL,email);
  }
  ...
  public CmsPath getHomeFolder() {
    if (this.homeFolder == null) {
      String homeFolderStr = (String)properties.get(VeloConstants.PROP_TEAM_HOMEFOLDER);
  ...
  public void setHomeFolderProperty(String folderPath){
    setProperty(VeloConstants.PROP_TEAM_HOMEFOLDER, folderPath);
  }
}
