...
/**
 */
public class UnmodifiableTeam extends UnmodifiableTeamImpl implements ITeam, IAdaptable {
  /**
   * Constructor for UnmodifiableTeam.
   * @param team ITeam
   */
  public UnmodifiableTeam(ITeam team) {
   super(team);
  }
