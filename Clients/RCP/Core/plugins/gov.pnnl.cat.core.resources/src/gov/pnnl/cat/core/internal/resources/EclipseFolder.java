...
/**
 */
public class EclipseFolder extends EclipseFolderImpl implements IFolder, IAdaptable {
  /**
   * Constructor for EclipseFolder.
   * @param path CmsPath
   * @param type QualifiedName
   * @param mgr IResourceManager
   */
  public EclipseFolder(CmsPath path, String type, IResourceManager mgr) {
    super(path, type, mgr);
  }
