 ...
 */
public class AlfrescoRepoWebserviceUtils {
  @SuppressWarnings("unused")
  private static Logger logger = CatLogger.getLogger(AlfrescoRepoWebserviceUtils.class);
  ...
  public static ParentReference getParentReference(String parentUuid, String fullyQualifiedChildName) {
    ...
    return new ParentReference(
        AlfrescoRepoWebserviceUtils.CAT_STORE,
        parentUuid,
        null,
  ...
  public static ParentReference getParentReference(CmsPath parentPath, String fullyQualifiedChildName) {
	  return getParentReference(parentPath, fullyQualifiedChildName, VeloConstants.ASSOC_TYPE_CONTAINS);
  }
  ...
  /**
   * Returns a <code>String</code> representation of an Alfresco <code>Reference</code> that can be used to set <code>NodeRef</code> properties.
   * @param store
   * @param resource the resource that the reference string will point to
  
  
  
   * @return a <code>String</code> reference * @throws ResourceException if an error occurs retrieving the UUID for the specified resource * @see #getReferenceFromReferenceString(String) */
  public static String getReferenceString(Store store, Resource resource) throws ResourceException {
    return store.getScheme() + "://" + store.getAddress() + "/" + resource.getUuid();
  }
   ...
   */
  public static String getReferenceString(Store store, IResource resource) throws ResourceException {
    return store.getScheme() + "://" + store.getAddress() + "/" + resource.getPropertyAsString(VeloConstants.PROP_UUID);
  }
   ...
   * @return String
   */
  public static String getReferenceString(IResource resource) {
    return CAT_STORE.getScheme() + "://" + CAT_STORE.getAddress() + "/" + resource.getPropertyAsString(VeloConstants.PROP_UUID);
  }
