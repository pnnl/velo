...
/**
 */
public class UnmodifiableUser extends UnmodifiableUserImpl implements IUser, IAdaptable {
  /**
   * Constructor for UnmodifiableUser.
   * @param user IUser
   */
  public UnmodifiableUser(IUser user) {
    super(user);
  }
