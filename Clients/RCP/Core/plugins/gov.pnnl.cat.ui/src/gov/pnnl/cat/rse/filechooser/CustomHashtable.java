...
/*********************************************************************************
 * We had to copy CustomHashtable from an internal jface package, because
 * this class is not visible.  We need this to merge the CheckboxTreeViewer with
 * RSE's SystemView class
 *********************************************************************************/
/**
