 ...
 ******************************************************************************/
package gov.pnnl.cat.ui.notification;
...
public class NotifierDialog {
    ...
    private static Color       _titleFgColor = new Color(Display.getCurrent() , 0, 0, 0);
    // text foreground color
    private static Color       _fgColor      = _titleFgColor;

    // shell gradient background color - top
    //private static Color       _bgFgGradient = new Color(Display.getCurrent() , 226, 239, 249);
    // shell gradient background color - bottom    
    private static Color       _bgBgGradient = new Color(Display.getCurrent() , 214, 214, 214);
    // shell border color
    private static Color       _borderColor  = new Color(Display.getCurrent() , 112, 112, 112);
    ...
    public static void notify(String title, String message) {
        ...
        _shell = new Shell(appShell, SWT.NO_FOCUS | SWT.NO_TRIM);
            ...
            public void handleEvent(Event e) {
                try {
                   ...
                   // gc.setForeground(_bgFgGradient);
                    gc.setForeground(_bgBgGradient);
        ...
        fd.height = 11;
        titleLabel.setFont(new Font(Display.getCurrent(), fd));
        ...
        if (appShell == null || appShell.getMonitor() == null) { return; }

        Rectangle clientArea = appShell.getMonitor().getClientArea();
