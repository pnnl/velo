 ...
 ******************************************************************************/
package gov.pnnl.cat.ui.viewers;
...
/**
 * Simple implementation of an {@link ITreeContentProvider} that uses a {@link DeferredTreeContentManager} to get children.
...
public class DeferredTreeContentProvider implements ITreeContentProvider {
  ...
  /**
   * Returns the {@link DeferredTreeContentManager} managing the content for this provider.
