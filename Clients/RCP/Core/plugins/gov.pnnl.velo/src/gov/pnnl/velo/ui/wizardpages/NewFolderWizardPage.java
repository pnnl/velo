 ...
 ******************************************************************************/
package gov.pnnl.velo.ui.wizardpages;
...
public class NewFolderWizardPage extends WizardPage {
	...
	private QualifiedName folderAspect;
	 ...
	 * @param folderAspect QualifiedName
	 * @param folderMimetype String
	 * @param window IWorkbenchWindow
	 */
	public NewFolderWizardPage(String title, String description, ISelection selection, QualifiedName folderAspect, String folderMimetype, IWorkbenchWindow window) {
	  this(title, description, selection, folderAspect, folderMimetype, window, null);
	}
	 ...
	 */
	public NewFolderWizardPage(String title, String description, ISelection selection, QualifiedName folderAspect, String folderMimetype, IWorkbenchWindow window, String defaultName) {
		super("wizardPage");
		this.folderAspect = folderAspect;
	...
	public void createControl(Composite parent) {
		...
		browseButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent e) {
				ResourceTreeDialog taxonomyDialog = new ResourceTreeDialog(window.getShell(), ResourcesPlugin.getResourceManager().getRoot(), false, false);
...
//				LoadingTreeNode root = new LoadingTreeNode(new CmsPath("/app:company_home/cm:Velo/cm:Registry/cm:Tools/cm:Workflows"));
//				taxonomyDialog.setRoot(root);
//				selResource = mgr.getResource(new CmsPath("/app:company_home/cm:Velo/cm:Registry/cm:Tools/cm:Workflows"));
	...
	private void initialize() {
		if (selection != null && selection.isEmpty() == false
				&& selection instanceof IStructuredSelection && containerFolder == null) {
		...
		if(defaultName != null) {
		  folderText.setText(defaultName);
		
		} else {
		  folderText.setText(getTitle());
		}
	...
	private void dialogChanged() {
		try {
			...
			if(this.containerFolder != null && this.folderAspect != null && this.folderAspect.equals(VeloConstants.ASPECT_TAXONOMY_ROOT) 
			...
			if(this.containerFolder != null && this.folderAspect != null && this.folderAspect.equals(VeloConstants.ASPECT_PROJECT)
	...
	/**
	 * Method setContainerFolder.
	 * @param containerFolder IResource
	 */
	public void setContainerFolder(IResource containerFolder) {
