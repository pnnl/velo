...
public class SearchPluginImages {
	...
	// The plugin registry
	private final static ImageRegistry PLUGIN_REGISTRY= CatRcpPlugin.getDefault().getImageRegistry();
	 ...
	 * @param prefix String
	 * @param name String
	 * @param useMissingImageDescriptor boolean
	 * @return ImageDescriptor
	 */
	private static ImageDescriptor create(String prefix, String name, boolean useMissingImageDescriptor) {
		IPath path= ICONS_PATH.append(prefix).append(name);
		return createImageDescriptor(CatRcpPlugin.getDefault().getBundle(), path, useMissingImageDescriptor);
	}
