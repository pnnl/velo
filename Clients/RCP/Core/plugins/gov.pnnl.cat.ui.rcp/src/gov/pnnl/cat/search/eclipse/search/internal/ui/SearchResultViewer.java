...
import gov.pnnl.cat.search.eclipse.search.internal.ui.util.FileLabelProvider;
...
public class SearchResultViewer extends TableViewer {
	...
	/**
	 * Constructor for SearchResultViewer.
	 * @param outerPart SearchResultView
	...
	public SearchResultViewer(SearchResultView outerPart, Composite parent) {
		...
		if (SearchPreferencePage.arePotentialMatchesEmphasized())
			fPotentialMatchFgColor= new Color(CatSearchPlugin.getActiveWorkbenchShell().getDisplay(), SearchPreferencePage.getPotentialMatchForegroundColor());
		...
		menuMgr.addMenuListener(
			new IMenuListener() {
				public void menuAboutToShow(IMenuManager mgr) {
					CatSearchPlugin.createStandardGroups(mgr);
					fillContextMenu(mgr);
				}
			});
	...
	void updateStatusLine() {
		...
		if (hasSingleSelection) {
			...
			CmsPath path= entry.getResource().getPath();
			if (path != null)
				location= path.toDisplayString();
		}
	...
	protected void inputChanged(Object input, Object oldInput) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(getControl(), CatRcpPlugin.getDefault().getSearchPlugin().getSearchViewHelpContextId());
	}

	/**
	 * Method getSelectedEntriesCount.
	 * @return int
	 */
	...
	/**
	 * Method enableRemoveMatchMenuItem.
	 * @return boolean
	 */
	...
	/**
	 * Method isPotentialMatchSelected.
	 * @return boolean
	 */
...
//		tbm.add(fGotoMarkerAction); see bug 15275
	...
	/**
	 * Method internalSetLabelProvider.
	...
	/**
	 * Handle a single add.
	 * @param entry ISearchResultViewEntry
	 */
