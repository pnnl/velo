 ...
 * how to model search results. {@link gov.pnnl.cat.search.eclipse.search.ui.text.AbstractTextSearchResult} and {@link gov.pnnl.cat.search.eclipse.search.ui.text.Match} can be used to port old searches to the new API design.
...
public interface ISearchResultViewEntry {
	 ...
	 * @return	the common resource of this entry's markers * @see	ISearchResultView#addMatch */
