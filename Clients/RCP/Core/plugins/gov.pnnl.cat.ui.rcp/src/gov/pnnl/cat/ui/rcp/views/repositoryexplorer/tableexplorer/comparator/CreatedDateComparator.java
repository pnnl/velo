...
/**
 * Sort by the {@link IResource} creation date.
 * @version $Revision: 1.0 $
 */
public class CreatedDateComparator extends TableExplorerComparator {
  ...
  protected int doCompare(IResource one, IResource two) {
    ...
    String strDate1 = resource1.getPropertyAsString(VeloConstants.PROP_CREATED);
    Date date1 = DateFormatUtility.parseJcrDate(strDate1);

    String strDate2 = resource2.getPropertyAsString(VeloConstants.PROP_CREATED);
