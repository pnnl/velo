 ...
 ******************************************************************************/
package gov.pnnl.cat.search.advanced.results;
...
/**
 */
public class AdvancedSearchResult extends BasicSearchResult {

  /**
   * Constructor for AdvancedSearchResult.
   * @param job ISearchQuery
   */
  public AdvancedSearchResult(ISearchQuery job) {
    super(job);
  }
