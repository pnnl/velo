...
public class UsersPerspective implements IPerspectiveFactory {
  ...
  public void createInitialLayout(IPageLayout layout) {
    ...
    topLeft.addView(CatViewIDs.USERS);
    ...
    topRight.addView(CatViewIDs.USER_DETAILS);

    layout.addNewWizardShortcut(CatWizardIDs.NEW_USER);
    layout.addNewWizardShortcut(CatWizardIDs.NEW_TEAM);

    layout.addShowViewShortcut(CatViewIDs.USERS);
    layout.addShowViewShortcut(CatViewIDs.USER_DETAILS);
