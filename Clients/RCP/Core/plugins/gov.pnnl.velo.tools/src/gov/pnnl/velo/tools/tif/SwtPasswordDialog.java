...
public class SwtPasswordDialog extends Dialog {
  ...
  private String[] prompts; // could have more than one prompt
  private boolean[] echo; // echo user input or use password box
  ...
  public SwtPasswordDialog( Shell parentShell, String dialogTitle,
      String dialogMessage, String errMessage, String[] prompts, boolean[] echo, String initialValue, IInputValidator validator) {
    super(parentShell);
  ...
  protected Control createDialogArea(final Composite parent) {
    ...
    if(echo[0]) {
      ...
      style = SWT.SINGLE | SWT.BORDER | SWT.PASSWORD;
    }
