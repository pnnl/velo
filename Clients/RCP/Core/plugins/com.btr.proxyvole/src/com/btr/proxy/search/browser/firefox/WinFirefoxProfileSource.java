...
class WinFirefoxProfileSource implements FirefoxProfileSource {
	...
	public File getProfileFolder() throws IOException {
		File appDataDir = new File(getAppFolder()); // TODO: their binary code is failing on windows 7 - returning chinese letters
		if(!appDataDir.exists()) {
		  String username = System.getenv("USERNAME");
		  appDataDir = new File("C:\\Users\\" + username + "\\AppData\\Roaming");
		}
