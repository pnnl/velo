...
public class ProtocolDispatchSelector extends ProxySelector {
	...
	public void setFallbackSelector(ProxySelector selector) {
		...
		Logger.log(getClass(), LogLevel.TRACE, "Setting default proxy selector: " + selector.toString());
	...
	public List<Proxy> select(URI uri) {
		...
		Logger.log(getClass(), LogLevel.TRACE, "Selecting proxy for uri:"+uri);
		//Logger.log(getClass(), LogLevel.TRACE, "Selecting proxy for scheme:"+uri.getScheme());		
