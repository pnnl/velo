...
public class ProxySearch implements ProxySearchStrategy {
	...
	public ProxySelector getProxySelector() {
		...
		for (ProxySearchStrategy strat : this.strategies) {
			try {
				System.out.println("Trying strategy " + strat.getClass().toString());
				long start = System.currentTimeMillis();
				ProxySelector selector = strat.getProxySelector();
				long end = System.currentTimeMillis();
				System.out.println("Time to execute strategy = " + (end - start) + " ms");
				if (selector != null) {
			...
			//System.out.println("Strategy failed trying next one.");
				e.printStackTrace();
