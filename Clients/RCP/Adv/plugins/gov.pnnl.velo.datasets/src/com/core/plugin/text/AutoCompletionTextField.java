...
/**
 * This class is used to ptovide an example of showing completion feature in a text field.
 * 
...
public class AutoCompletionTextField {
  ...
  /**
   * Method used to display an array of String data for autocompletion. You can have your own method like this to get the autocompletion data. This method can be customized to get the data from database and you can display as autocompletion array.
   *
   * @param text
   *          of type String
  ...
  /**
   * This method is used to provide the implementaion of eclipse autocompletion feature. User has to press "CTRL+Space" to see the autocompletion effect.
   *
   * @param text
   *          of type {@link Text}
   * @param value
  ...
  public static void main(String[] args) {
    ...
    new AutoCompleteField(textField, new TextContentAdapter(), new String[] { "autocomplete option 1", "autocomplete option 2" });
