...
public class SWTFactory {
   ...
   * @param numColumns int
	 ...
	 * @return Group
	 */
  public static Group createGroup(int numColumns, Composite parent, String text ) {
    final Group group= new Group(parent, SWT.NONE);
    GridData gd= new GridData(GridData.FILL_HORIZONTAL);
    // XXX: (SDH) This is a bug either in terminolOgy or desired outcome
    //      horizontalSpan is not the same as numColumns
	...
	public static void showPreferencePage(String page_id, String[] page_filters) {
		PreferencesUtil.createPreferenceDialogOn(Display.getDefault().getActiveShell(), page_id, page_filters, null).open();
	}
