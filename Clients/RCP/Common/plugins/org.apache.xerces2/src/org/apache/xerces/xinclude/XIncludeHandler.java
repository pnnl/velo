...
public class XIncludeHandler
    ...
    protected boolean handleIncludeElement(XMLAttributes attributes)
        ...
        // Velo change to support Eclipse plugin URI's
        } else if(href.startsWith("platform:")) {
          // Convert the Eclipse URI into a File URI
          try {
            URL url = new URL(href);
            href = FileLocator.toFileURL(url).toString();
