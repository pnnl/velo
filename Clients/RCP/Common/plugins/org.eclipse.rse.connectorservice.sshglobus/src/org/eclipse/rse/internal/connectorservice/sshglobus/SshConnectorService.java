...
package org.eclipse.rse.internal.connectorservice.sshglobus;
 ...
 */
public class SshConnectorService extends StandardConnectorService implements ISshSessionProvider, IGlobusOnlineConnectorService
{
	...
	private static final String PROPERTY_SET_SSH_SETTINGS = "SSH Properties"; //$NON-NLS-1$
...
//	    System.out.println(myProxyHost);
  ...
  @Override
	  public IPropertySet setGlobusOnlineProperties(String endpointId, String myProxyHost, String globusAccessiblePath) {
	    ...
	    IPropertySet propertySet = getGlobusPropertySet();
	...
	protected Session createSession(String username, String password, String hostname, int port, UserInfo wrapperUI, IProgressMonitor monitor) throws JSchException {
		...
		IPropertySet propertySet = getSshPropertySet();
	...
	private IPropertySet getGlobusPropertySet() {
	...
	private IPropertySet getSshPropertySet()
	{
	...
	public SystemSignonInformation getSshSignonInformation() {
		return super.getSignonInformation();
	}
