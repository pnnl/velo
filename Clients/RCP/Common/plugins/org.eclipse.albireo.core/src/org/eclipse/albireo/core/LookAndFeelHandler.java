...
public class LookAndFeelHandler {
    ...
    static class UnsupportedLookAndFeelRuntimeException extends RuntimeException {
        /**
         * Constructor for UnsupportedLookAndFeelRuntimeException.
     ...
     * @return The corresponding AWT font. * @see #isSwtDefaultFontPropagated() * @see #updateLookAndFeelFonts(java.awt.Font) */
