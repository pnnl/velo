...
public class FocusHandler {
    ...
    /**
     * Constructor for FocusHandler.
     * @param swingControl SwingControl
     * @param globalHandler GlobalFocusHandler
     * @param borderless Composite
     * @param frame Frame
     */
    ...
    /**
     * Method processTypeAheadKeys.
     * @param callerSeqNum int
     */
     ...
     * @param direction int
     * @param count int
     * @param flushingTypeAhead boolean
     */
    ...
    /**
     * Method handleSynthesizeException.
     * @param e Exception
     */
    ...
    /**
     * Method adjustFocusForSwtTraversal.
     * @param currentSwtTraversal int
     */
    ...
    /**
     * Method setInitialTraversalFocus.
