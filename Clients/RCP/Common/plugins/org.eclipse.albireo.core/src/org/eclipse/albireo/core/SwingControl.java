...
public abstract class SwingControl extends Composite {
    ...
    private Listener settingsListener = new Listener() {
        public void handleEvent(Event event) {
            //System.out.println("SwingControl recieved SWT event: " + event.type);
     ...
     * </ul> * @exception IllegalArgumentException <ul>
     *    <li>ERROR_NULL_ARGUMENT - if the parent is null</li>
     * </ul> * @see Widget#getStyle */
     ...
     *         <code>null</code> * @see #preferredSizeChanged(Point, Point, Point) */
  ...
     * set that approximately matches the window's contents.
    ...
    /**
     * Method updateDefaultFont.
     * @param swtFont Font
     * @param swtFontData FontData[]
     */
    private void updateDefaultFont(Font swtFont, FontData[] swtFontData) {
        ...
        if(awtFont.equals(this.awtFont)) {
          return;
        }
    ...
    /**
     * Method setComponentFont.
     * @param swtFont Font
     * @param swtFontData FontData[]
     * @param preserveDefaults boolean
     */
    ...
    */
     ...
     * </ul> * @see SizeListener * @see #removeSizeListener(SizeListener) */
     ...
     * </ul> * @exception IllegalArgumentException <ul>
     *    <li>ERROR_NULL_ARGUMENT - if the listener is null</li>
     * </ul> * @see SizeListener * @see #addSizeListener(SizeListener) */
    ...
    /**
     * Method firePreferredSizeChangedEvent.
     * @param minSize Point
     * @param prefSize Point
     * @param maxSize Point
     */
    ...
    /**
     * Method initPopupMenuSupport.
     * @param root javax.swing.JRootPane
     */
