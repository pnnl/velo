...
public class AwtDialogListener implements AWTEventListener, ComponentListener, WindowFocusListener {
    ...
    public AwtDialogListener(Display display) {
        ...
        if(AwtEnvironment.isSyncModalDialogs()) {
    ...
    /**
     * Method handleAlwaysOnTopException.
     * @param e Exception
     */
    ...
    /**
     * Method handleRemovedDialog.
     * @param awtDialog Dialog
     * @param removeListener boolean
     */
     ...
     * @see java.awt.event.AWTEventListener#eventDispatched(AWTEvent)
     */
