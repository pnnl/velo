 ...
 */
public class GlobusOnlineConnectorServiceManager extends AbstractConnectorServiceManager
{
 	private static GlobusOnlineConnectorServiceManager inst = null;
  
    /**
     * Private constructor to ensure not instantiated this way.
     * Use getDefault instead.
     */
    private GlobusOnlineConnectorServiceManager()
    {
    }
     ...
     */
    public static GlobusOnlineConnectorServiceManager getInstance()
    {
    	if (inst == null)
    	  inst = new GlobusOnlineConnectorServiceManager();
    	return inst;
    }
    ...
    {
    	return new GlobusOnlineConnectorService(host, 22);
    }    
    ...
    {
    	return IGlobusOnlineSubSystem.class;
    }
	/**
	...
	{
		return (otherSubSystem instanceof IGlobusOnlineSubSystem);
	}
}