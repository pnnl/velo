...
public class GlobusOnlineRemoteFile extends AbstractRemoteFile 
{
	protected GlobusOnlineHostFile _globusOnlineHostFile;

	public GlobusOnlineRemoteFile(FileServiceSubSystem ss, IRemoteFileContext context, IRemoteFile parent, GlobusOnlineHostFile hostFile) 
	{
		super(ss, context, parent, hostFile);
		_globusOnlineHostFile = hostFile;
	}
	...
	{
		return _globusOnlineHostFile.getClassification();
	}
