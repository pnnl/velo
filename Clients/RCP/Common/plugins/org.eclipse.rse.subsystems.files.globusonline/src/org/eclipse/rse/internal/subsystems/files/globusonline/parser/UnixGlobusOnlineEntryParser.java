...
import org.eclipse.rse.internal.services.files.globusonline.GlobusOnlineFile;
 ...
 */
public class UnixGlobusOnlineEntryParser implements GlobusOnlineFileEntryParser
{
     ...
     */
    public UnixGlobusOnlineEntryParser()
    {
//        this(null);
    }
     ...
     * @since 1.4
     */
//    public UnixGlobusOnlineEntryParser(GlobusOnlineClientConfig config)
//    {
//        super(REGEX);
//        configure(config);
//    }
...
//    @Override
     ...
     */
    public GlobusOnlineFile parseGlobusOnlineEntry(String entry) {
    	GlobusOnlineFile file = new GlobusOnlineFile();
        ...
        if (matcher.matches())
        {
            ...
            String hardLinkCount = matcher.group(15);
            String usr = matcher.group(16);
            String grp = matcher.group(17);
            String filesize = matcher.group(18);
            String datestr = matcher.group(19) + " " + matcher.group(20);
            String name = matcher.group(21);
            String endtoken = matcher.group(22);
...
//            }
            ...
            for (int access = 0; access < 3; access++, g += 4)
            {
                ...
                file.setPermission(access, FTPFile.READ_PERMISSION,
                                   (!matcher.group(g).equals("-")));
                file.setPermission(access, FTPFile.WRITE_PERMISSION,
                                   (!matcher.group(g + 1).equals("-")));

                String execPerm = matcher.group(g + 2);
