...
public class GlobusOnlineFile implements Serializable
{
    ...
    public String toFormattedString()
    {
        ...
        Object[] array  = {Integer.valueOf(getHardLinkCount())};
        fmt.format(" %4d", array );
        
        array = new Object[2];
        array[0] = getGroup();
        array[1] = getUser();
        fmt.format(" %-8s %-8s", array);
        
        array = new Object[1];
        array[0] = Long.valueOf(getSize());
        fmt.format(" %8d", array);
        ...
        if (timestamp != null) {
            ...
            SimpleDateFormat simpleFormat = new SimpleDateFormat(" %1$tY-%1$tm-%1$td %1$tH:%1$tM:%1$tS");
            String date1 = simpleFormat.format(timestamp);
