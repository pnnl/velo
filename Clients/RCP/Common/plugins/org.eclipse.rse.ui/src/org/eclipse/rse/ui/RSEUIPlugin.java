...
{
  private static final Logger logger = Logger.getLogger(RSEUIPlugin.class);
    ...
    protected void initializeImageRegistry()
    {
		...
		*/
	    ...
	    // add globus online image
      putImageInRegistry(ISystemIconConstants.ICON_GLOBUS_ID,
          path+ISystemIconConstants.ICON_GLOBUS);
...
//						   path+ISystemIconConstants.ICON_SYSTEM_WORKWITHCOMPILECMDS);
    ...
    public void start(BundleContext context) throws Exception
    {
      try {
        ...
        logger.error("Failed to start RSE UI plugin.", e); //$NON-NLS-1$
      }
	}
