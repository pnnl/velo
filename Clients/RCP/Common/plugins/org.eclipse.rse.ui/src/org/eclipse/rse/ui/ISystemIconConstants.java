...
public interface ISystemIconConstants
{
	...
	public static final String ICON_GLOBUS_ROOT = "globus";
	public static final String ICON_GLOBUS = ICON_MODEL_DIR + ICON_GLOBUS_ROOT + ".png";
	public static final String ICON_GLOBUS_ID = "PREFIX + ICON_GLOBUS_ROOT + ICON_SUFFIX";
