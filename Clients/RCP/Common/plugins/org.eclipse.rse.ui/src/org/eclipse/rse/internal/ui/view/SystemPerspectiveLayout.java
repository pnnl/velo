...
public class SystemPerspectiveLayout implements IPerspectiveFactory
{
    ...
    /* Velo Change - get rid of remote scratchpad as a default view in the RSE perspective
...
//                (float).75, "org.eclipse.rse.ui.view.NavFolder"); //$NON-NLS-1$
		...
		/* Velo Change - add remote scratchpad as a view shortcut */
		layout.addShowViewShortcut(SystemScratchpadViewPart.ID);
