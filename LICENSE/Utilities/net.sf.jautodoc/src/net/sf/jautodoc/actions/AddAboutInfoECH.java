 ...
 */
public class AddAboutInfoECH extends AbstractECH {
  	...
  	protected void execute(IEditorPart activeEditor) {
  	    if (AboutConstants.DEBUG_MODE) System.out.println(AboutConstants.DEBUG + "AddAboutInfoECH");
    		AddAboutInfoEAD ead = new AddAboutInfoEAD();
