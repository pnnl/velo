...
/**
 * Editor action delegate for generating about information.
 */
public class AddAboutInfoEAD extends AbstractEAD {

    @Override
    protected void doRun(final SourceManipulator sm, final ICompilationUnit compUnit, final Configuration config,
            final IProgressMonitor monitor) throws Exception {
      if (AboutConstants.DEBUG_MODE) System.out.println(AboutConstants.DEBUG + "AddAboutInfoEAD:doRun");
        try {
