...
public interface Constants {
    ...
    // --------------------------------
    // header license regex match patterns
    // 
    // Added by Cody 109492
    // --------------------------------
    
    /**
     * MATCH_COMMENT regex
     * WARNING: Does not work for nested comments
     * 
     * \\/\\*               # Match beginning of Java comment block (key character must be double-escaped in Java)
     * (?:[^*]              # Read through any non-'*' characters in comment block
     * |(?:\\*+[^\\/*]))*+  #   and any following non-'/' characters if a '*' happens to be found without backtracking
     * \\*+\\/              # Complete match with end of comment block ('*'+'/')
     * |\\/\\/.*            # Alternatively match single-line comment
     * 
     */
    public static final String MATCH_COMMENT = "\\/\\*(?:[^*]|(?:\\*+[^\\/*]))*+\\*+\\/|\\/\\/.*";
    // public static final String MATCH_COMMENT = "\\/\\*+(?>[^*]|\\*[^\\/])*\\*+\\/|\\/\\/[^\\r\\n]*";
    // public static final String MATCH_NO_HEADER = "(?s)\\A(?>(?:.*?\\/[\\/\\*][^\\{]*(?=\\{|;\\s*\\Z))?)\\A.*\\Z";
    
//    public static final String MATCH_GNU_GPL = "(?is)\\A.*?GNU.*\\Z";
//    public static final String MATCH_LEGAL = "(?is)\\A.*(?>copyright|license).*\\Z";
    public static final String MATCH_VELO = "(?s)\\A.*?Velo\\b.*\\Z";
    
    // --------------------------------
    // console name and console message substrings
    // 
    // Added by Cody
    // --------------------------------
    public static final String DEFAULT_CONSOLE_NAME = "JAutodoc Console";
    
    public static final String CONSOLE_INIT = "INIT";
    public static final String CONSOLE_DONE = "DONE";
    public static final String CONSOLE_ERROR = "!ERROR ";
    public static final String CONSOLE_FOUND = "!FOUND ";
    public static final String CONSOLE_MISSING = "!MISSING ";
    public static final String CONSOLE_MULTIPLE = "Multiple licensing headers";
    public static final String CONSOLE_GNU = "GNU General Public License";
    public static final String CONSOLE_NO_VELO = "Velo header is not found";
    public static final String CONSOLE_NOT_FOUND = "Search for header failed in";
}
