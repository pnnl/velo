...
public final class Utils {
    // Modified by Cody
    public static final MessageConsole console = findConsole(Constants.DEFAULT_CONSOLE_NAME);
    public static final MessageConsoleStream out = console.newMessageStream();
    
    // Added for Velo
    public static final boolean isDeclarationOrEOF(int token) {
      return token == ITerminalSymbols.TokenNameclass ||
