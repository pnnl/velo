...
/**
 */
public class JobStatusWebScript extends AbstractVeloWebScript{
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    try {
      ...
      String status =jobLaunchingService.getStatus(launchObject.getJobConfig(), launchObject.getCredentials());
      writeMessage(res, status);
