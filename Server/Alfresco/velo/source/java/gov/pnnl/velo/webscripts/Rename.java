 ...
 */
public class Rename extends AbstractVeloWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    String newName = req.getParameter(PARAM_NEW_NAME);
    
    rename(wikiPath, newName);
   ...
   * @throws Exception
   */
  public void rename(String wikiPath, String newName) throws Exception{
