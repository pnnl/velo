...
/**
 */
public class CodeRegistryAlfresco extends CodeRegistryDefault {
  protected Log logger = LogFactory.getLog(CodeRegistryAlfresco.class);
  ...
  @Override
  public void init() {
    // add code definitions saved on alfresco server
