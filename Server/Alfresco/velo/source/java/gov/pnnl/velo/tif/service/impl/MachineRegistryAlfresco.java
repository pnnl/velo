...
/**
 */
public class MachineRegistryAlfresco extends MachineRegistryAdapter {
  protected Log logger = LogFactory.getLog(MachineRegistryAlfresco.class);
  ...
  @Override
  public void init() {
    // add machine definitions saved on alfresco server
