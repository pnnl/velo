...
public class PropFindMethod extends WebDAVMethod
{
  ...
  protected static final int FIND_PROPS = 2;
     ...
     * @exception WebDAVServerException * @throws Exception
     */
    protected void executeImpl() throws WebDAVServerException, Exception
    {
        ...
        try
        {
          // VELO Change:  Fixed a bug where Alfresco wasn't using getPath() method
          // and instead was hard coding m_strPath
          // Check that the path exists
          pathNodeInfo = getDAVHelper().getNodeForPath(rootNodeRef, path, servletPath);
        }
