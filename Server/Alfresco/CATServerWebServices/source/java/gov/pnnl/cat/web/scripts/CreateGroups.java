...
import gov.pnnl.cat.server.webservice.group.NewGroupDetails;
...
/**
 * Create groups.  For now this web script just forwards calls to GroupWebService to
 * avoid axis calls from client.
 * @author d3k339
 *
 * @version $Revision: 1.0 $
 */
public class CreateGroups extends AbstractCatWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    NewGroupDetails[] newGroups = mapper.readValue(requestContent, NewGroupDetails[].class);
    GroupDetails[] createdGroups = groupWebService.createGroupsImpl(newGroups);
    mapper.writeValue(res.getOutputStream(), createdGroups);
    return null;
