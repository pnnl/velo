...
/**
 * Get user details.  For now this web script just forwards calls to UserWebService to
 * avoid axis calls from client.
 * @author d3k339
 *
 * @version $Revision: 1.0 $
 */
public class GetUser extends AbstractCatWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    UserDetails user = userWebService.getUserImpl(userName);
