...
/**
 * Change Password.  For now this web script just forwards calls to UserWebService to
 * avoid axis calls from client.
 * @author d3k339
 *
 * @version $Revision: 1.0 $
 */
public class ChangePassword extends AbstractCatWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    ChangePasswordRequest request = mapper.readValue(requestContent, ChangePasswordRequest.class);
    userWebService.changePasswordImpl(request.getUserName(), request.getOldPassword(), request.getNewPassword());
    return null;
