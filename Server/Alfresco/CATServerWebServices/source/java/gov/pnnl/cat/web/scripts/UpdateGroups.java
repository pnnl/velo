...
/**
 * Update groups.  For now this web script just forwards calls to GroupWebService to
 * avoid axis calls from client.
 * @author d3k339
 *
 * @version $Revision: 1.0 $
 */
public class UpdateGroups extends AbstractCatWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    GroupDetails[] groups = mapper.readValue(requestContent, GroupDetails[].class);
    GroupDetails[] updatedGroups = groupWebService.updateGroupsImpl(groups);
    mapper.writeValue(res.getOutputStream(), updatedGroups);
    return null;
