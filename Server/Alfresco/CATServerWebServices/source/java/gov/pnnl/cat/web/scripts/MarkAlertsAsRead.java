...
public class MarkAlertsAsRead extends AbstractCatWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    RepositoryAlert[] wsRepoAlerts = mapper.readValue(requestContent, RepositoryAlert[].class);
    alertWebService.markAlertsAsRead(wsRepoAlerts, true);
    return null;
