...
/**
 * Update users.  For now this web script just forwards calls to UserWebService to
 * avoid axis calls from client.
 * @author d3k339
 *
 * @version $Revision: 1.0 $
 */
public class UpdateUsers extends AbstractCatWebScript {
  ...
  protected Object executeImpl(WebScriptRequest req, WebScriptResponse res, File requestContent) throws Exception {
    ...
    UserDetails[] users = mapper.readValue(requestContent, UserDetails[].class);
    UserDetails[] updatedUsers = userWebService.updateUsersImpl(users);
    mapper.writeValue(res.getOutputStream(), updatedUsers);
    return null;
