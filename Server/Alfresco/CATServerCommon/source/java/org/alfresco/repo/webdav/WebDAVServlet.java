...
public class WebDAVServlet extends HttpServlet
{
            ...
            IOException
    {
        ...
        {
            // CAT Change: get the root cause to include in the error message
            ...
            if (e instanceof WebDAVServerException)
            {
                ...
                {
                    // CAT change: also include error message in response
                    response.sendError(error.getHttpStatusCode(), rootCause.toString());
                }
            }
            else
            {
                ...
                {
                    // CAT change: also include error message in response
                    response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, rootCause.toString());
                }
            }
        }
        finally
