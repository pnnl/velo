    ...
    protected void executeImpl(Action action, final NodeRef actionedUponNodeRef)
    {
        ...
        AuthenticationUtil.runAs(new RunAsWork<Object>()
        {
            ...
            public Object doWork() throws Exception
            {
                ...
                // Zoe's adding text transform to the list of aspects to exclude because otherwise the zip file created will contain 2 entries per file that has 
                // been transformed: one entry for the real file's content, and one for the transformed text.  WinZip considers this invalid and the real
                // file cannot be unzipped
                crawlerParameters.setExcludeAspects(new QName[] {ContentModel.ASPECT_WORKING_COPY, CatConstants.ASPECT_TEXT_TRANSFORM});
                // VELO CHANGE END
