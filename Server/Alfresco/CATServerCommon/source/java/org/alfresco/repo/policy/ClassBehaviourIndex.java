...
/*package*/ class ClassBehaviourIndex<B extends ClassBehaviourBinding> implements BehaviourIndex<B>
{
    ...
    public Collection<BehaviourDefinition> find(B binding)
    {
        ...
        try
        {
            ...
            // Velo Change:  I think this is an alfresco bug.  They should be checking to see if all policy are
            // globally disabled by the BehaviourFilter and only run service-level behaviours if not
            if(filter.isEnabled()) {
