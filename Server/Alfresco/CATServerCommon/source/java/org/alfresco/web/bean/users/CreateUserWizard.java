...
public class CreateUserWizard extends BaseWizardBean
{
            ...
            Map<QName, Serializable> props, NodeRef oldHomeFolderRef, FacesContext context)
    {
        ...
        // CAT Change: Do not have the web bean create a home folder, since the HomeFolderManager and
        // HomeFolderProvider defined in config files will auotomatically create it for you
