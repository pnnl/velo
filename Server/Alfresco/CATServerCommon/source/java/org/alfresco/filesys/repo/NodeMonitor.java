									 ...
									 Runnable
{
	...
	public final void init() 
	{
        ...
        // Velo Change:  make this bind to transaction commit instead of every event
        m_policyComponent.bindClassBehaviour( QName.createQName(NamespaceService.ALFRESCO_URI, "onUpdateProperties"),
    		  	this, new JavaBehaviour(this, "onUpdateProperties", NotificationFrequency.TRANSACTION_COMMIT));
    ...
    public void onUpdateProperties( NodeRef nodeRef, Map<QName, Serializable> before, Map<QName, Serializable> after) {
      ...
      if(!m_nodeService.exists(nodeRef)) {
        return;
      }
      // End Velo Change
