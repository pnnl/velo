...
public class EasySSLProtocolSocketFactory implements SecureProtocolSocketFactory {
     ...
     * @param localPort int
     * @return Socket a new socket * @throws IOException if an I/O error occurs while creating the socket * @throws UnknownHostException if the IP address of the host cannot be
     * determined * @throws ConnectTimeoutException
     * @see org.apache.commons.httpclient.protocol.ProtocolSocketFactory#createSocket(String, int, InetAddress, int, HttpConnectionParams)
     */
    public Socket createSocket(
        final String host,
        final int port,
