...
public class WebScriptServletRequest extends WebScriptRequestImpl
{
     ...
     * @param name String
     * @return String[]
     * @see org.springframework.extensions.webscripts.WebScriptRequest#getParameterValues(String)
     */
    ...
    /**
     * VELO Change:  Making an accessor to the FormData, since this
     * is the only way we can get multiple files from a multipart multiple
     * file upload.
