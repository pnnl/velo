...
/**
 */
public class MaterialTypeConstraint extends AbstractConstraint {

  private static final Log logger = LogFactory.getLog(MaterialTypeConstraint.class);
  ...
  protected void evaluateSingleValue(Object value) {
    ...
    boolean found = false;
    Collection<String> validValues = criminalIntelOptionsBean.getAllowedIntelTypeValues();
  ...
  public Map<String, String> getIntelTypes(){
    return criminalIntelOptionsBean.getIntelTypes();
  }
