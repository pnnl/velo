 ...
 */
public class TextTransformPatch extends AbstractPatch {

  //Logger
  
  private static final Log logger = LogFactory.getLog(TextTransformPatch.class);
  ...
  protected String applyInternal() throws Exception {
    ...
    String crawlerName = "textTransformConvertTreeCrawler";
    Action action = actionService.createAction(actionName);
    action.setParameterValue(TreeCrawlerActionExecutor.VISITOR_ID, crawlerName);
