 ...
 */
public class OwnablePatch extends AbstractPatch {

  // Logger
  private static final Log logger = LogFactory.getLog(OwnablePatch.class);
  ...
  protected void checkRequiredProperties() throws Exception
  {
      ...
      checkPropertyNotNull(actionService, "actionService");
  ...
  protected String applyInternal() throws Exception {
    ...
    NodeRef userDocuments = nodeUtils.getNodeByName(CatConstants.PATH_USER_DOCUMENTS);
    NodeRef teamDocuments = nodeUtils.getNodeByName(CatConstants.PATH_TEAM_DOCUMENTS);
