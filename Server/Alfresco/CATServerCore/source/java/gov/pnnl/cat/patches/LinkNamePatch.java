...
/**
 * This patch changes the name of all filelink nodes to end with .url
 * so they are visible via CIFS.
 * @version $Revision: 1.0 $
 */
public class LinkNamePatch extends AbstractPatch {

  // Logger
  private static final Log logger = LogFactory.getLog(LinkNamePatch.class);
  ...
  protected String applyInternal() throws Exception {
    ...
    String visitorName = "linkNameNodeVisitor";
