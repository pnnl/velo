 ...
 */
public class RecursiveAddAspectAction extends ActionExecuterAbstractBase
{

  /**
   * The logger
   */
  private static Log logger = LogFactory.getLog(RecursiveAddAspectAction.class); 
  ...
  protected void executeImpl(Action action, NodeRef actionedUponNodeRef) {
    ...
    recursiveAddAspect(actionedUponNodeRef, aspect);
  }

  /**
   * Method recursiveAddAspect.
   * @param nodeRef NodeRef
   * @param aspect QName
   */
  private void recursiveAddAspect(final NodeRef nodeRef, final QName aspect) {
    ...
    for (ChildAssociationRef childAssoc : children) {
      recursiveAddAspect(childAssoc.getChildRef(), aspect);
    }
